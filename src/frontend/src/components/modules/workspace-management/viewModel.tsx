...
class ViewModel extends ContentStore {
  ...
  */
  ...
  /**
  * Function for filling the ontology arrays for the pie chart.
  */
  public fillOntologyPieArrays(){
    this.ontologyPieValues=[]
    this.ontologyPieLabels=[]
    this.ontologyPieTwoValues=[]
    this.ontologyPieTwoLabels=[]
    this.currentWorkspace.ontologies.forEach((o)=>{
      this.ontologyPieValues.push(Number(o.countTriples))
      this.ontologyPieLabels.push(o.title)
      this.ontologyPieTwoValues.push(Number(o.countUsage))
      this.ontologyPieTwoLabels.push(o.title)
    })
  }

  /**
  * Function for filling the user array for the pie chart.
  */
  public fillUsersPieArrays(){
    this.usersPieValues=[]
    this.usersPieLabels=[]
    this.currentWorkspace.users.forEach((u)=>{
      this.usersPieValues.push(u.countDatasets)
      this.usersPieLabels.push(u.firstname + ' ' + u.lastname)
    })
  }
  ...
  */
  public async getCurrentWorkspace(){
    try {
      ...
      this.fillOntologyPieArrays();
      this.fillUsersPieArrays();
      await this.getUsers();
    } catch (ex) {
